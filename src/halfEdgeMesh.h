   ...
   */
   ...
   class Halfedge : public HalfedgeElement
   {
      public:
         ...
         //cotangent of the angle across the halfedge
         // for triangle ABC cot(halfedge(bc)) = angle BAC
         double cotan;
   ...
   class Vertex : public HalfedgeElement
   {
      public:
        ...
        //references to original position and normal of the vertices
        //used for updates
        Vector3D original_position;
        Vector3D original_normal;
       
        //index into the vertices list
        long index;
   ...
   class HalfedgeMesh
   {
      public:
         ...
         VertexIter   collapseEdge( EdgeIter e ); ///< collapse an edge, returning a pointer to the collapsed vertex
          ...
          /* Diagonal Mass matrix vector */
          Eigen::VectorXd mass_diagonal;
       
          /* Vertices set by user and their corresponding height */
          map <long,double> set_map;
